...
/****** Object:  Database [ElimDB]    Script Date: 02/04/2024 21:16:33 ******/
DROP DATABASE [ElimDB]
GO
...
CREATE DATABASE [ElimDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ElimDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ElimDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ElimDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ElimDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [ElimDB].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
...
ALTER DATABASE [ElimDB] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [ElimDB] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
...
ALTER DATABASE [ElimDB] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [ElimDB] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [ElimDB] SET DB_CHAINING OFF 
GO

ALTER DATABASE [ElimDB] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
...
ALTER DATABASE [ElimDB] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [ElimDB] SET QUERY_STORE = ON
GO

ALTER DATABASE [ElimDB] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
